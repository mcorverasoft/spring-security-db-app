...
@SpringBootTest
public class SpringSecurityBDAppApplicationTests {
	@Autowired
	...
	public SpringSecurityBDAppApplicationTests() {
	...
	public void createRoleTest() {
		...
		roleTest.setName(RoleName.ROL_ADMIN);
		roleTest.setDescription("ROLE FOR ADMIN USERS");
